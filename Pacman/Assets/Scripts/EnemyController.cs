...
public class EnemyController : MonoBehaviour
{
    ...
    public void Setup()
    {
        ...
        //Set readyToLeaveHome to be false if the are blue or pink
        if (ghostType == GhostType.red)
        {
    ...
    void Update()
    {
        ...
        if(ghostNodeState != GhostNodeStatesEnum.movingNodes || !gameManager.isPowerPelletRunning )
        {
            isFrightened = false;
        }
        ...
        if (gameManager.powerPelletTime - gameManager.currentPowerPelletTime <= 3)
        {
        ...
        {
            movementController.SetSpeed(1.2f);
        }
        else
        {
            if (isFrightened)
    ...
    {
        if (ghostNodeState == GhostNodeStatesEnum.movingNodes)
        {
            leftHomeBefore = true;
            // Scatter mode
        ...
        else if(ghostNodeState == GhostNodeStatesEnum.respawning)
        {
            ...
            // We have reached our center node, either finish respawn or move to the left node
        ...
        else
        {
            ...
            if (readyToLeaveHome)
            {
                ...
                {
                    ghostNodeState = GhostNodeStatesEnum.movingNodes;
                    movementController.SetDirection("left");
                }
            }
        }
    ...
    void DetermineOrangeGhostDirection()
    {
        ...
        // If we are whithin 8 nodes of pacman, chase him using red's logic
    ...
    string GetClosestDirection(Vector2 target)
    {
        ...
        if (nodeController.canMoveUp && lastMovingDirection != "down")
        {
            ...
            //If this is the shortest direction so far set our direction
