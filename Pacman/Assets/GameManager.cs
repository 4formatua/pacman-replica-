...
public class GameManager : MonoBehaviour
{
    ...
    public float powerPelletTime = 8f;


    public int powerPelletMultiplayer = 1;
    ...
    public IEnumerator Setup()
    {
        ...
        // if pacman clears a level, a background will appear coverting the level, and the game will pause for 0.1 seconds
        if (clearLevel)
        {
    ...
    void Update()
    {
        ...
        if (isPowerPelletRunning)
        {
            ...
            if(currentPowerPelletTime >= powerPelletTime)
            {
                isPowerPelletRunning = false;
                currentPowerPelletTime = 0;
                powerPelletAudio.Stop();
                siren.Play();
                powerPelletMultiplayer = 1;
            }
        }
    }
    ...
    public void GhostEaten()
    {
        ...
        AddToScore(400 * powerPelletMultiplayer);
        powerPelletMultiplayer++;
